    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 items-start">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div className="flex-grow space-y-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-lg sm:text-xl font-semibold text-brand-text-heading">{result.detectedCondition}</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-lg sm:text-xl font-semibold text-brand-text-heading">{result.severityStage}</p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="bg-brand-surface rounded-lg p-4 sm:p-6 border border-brand-border">
                ...
                <p className="text-brand-text-light mb-4">{result.analysisExplanation.summary}</p>
